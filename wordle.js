...
let word;
let correctAttempts = 0; // Track successful attempts
...
function clearBoard() {
  // Clear previous guesses on the board
...
function processInput(e) {
  ...
  if ("KeyA" <= e.code && e.code <= "KeyZ") {
    if (col < width) {
      ...
      if (currTile !== null && currTile.innerText == "") {
  ...
  if (!gameOver && row === height) {
    ...
    let answerElement = document.getElementById("answer");
    if (answerElement !== null) {
      answerElement.innerText = "Congratulations! You guessed the word!";
    }
  }
}
...
function update() {
  ...
  if (!guessList.includes(guess)) {
    if (answerElement !== null) {
      answerElement.innerText = "Not in word list";
    }
    return;
  }
